...
This is the final project for the iOS App Capstone, part of the Meta iOS App Capstone Certificate program. The app is a food ordering app that allows users to browse Little Lemon restaurant's menu and place orders.
